...
public class e
{
    ...
    synchronized (new h(this, (com.google.ads.internal.h)this.a.i().g.a(), paramf, paramString, paramAdRequest, paramHashMap))
    {
      ...
      catch (InterruptedException localInterruptedException)
      {
        ...
        if ((???.c()) && (???.d()))
        {
          ...
          {
            ((Handler)m.a().c.a()).post(new e.8(this, ???, localView, paramf));
            return true;
          }
        }
        if (!???.c())
  ...
  private void b(c paramc, AdRequest paramAdRequest)
  {
    ...
    return;
    label294: ((Handler)m.a().c.a()).post(new e.7(this, paramc));
  }
  ...
  public void a(h paramh, View paramView)
  {
    ...
    this.a.n().a(g.a.a);
    f localf = this.b.a();
    ((Handler)m.a().c.a()).post(new e.3(this, paramView, localf));
  }
  ...
  public void a(h paramh, boolean paramBoolean)
  {
    if (!a(paramh, "onAdClicked()"))
      return;
    f localf = paramh.a();
    ((Handler)m.a().c.a()).post(new e.2(this, localf, paramBoolean));
  }
