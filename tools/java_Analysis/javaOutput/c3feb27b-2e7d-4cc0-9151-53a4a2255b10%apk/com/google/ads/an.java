...
public class an
{
    ...
    throws an.a, ap
  {
    ...
    {
      byte[] arrayOfByte1;
      throw new an.a(localNoSuchAlgorithmException);
    ...
    {
      throw new an.a(localInvalidKeyException);
    }
    catch (IllegalBlockSizeException localIllegalBlockSizeException)
    {
      throw new an.a(localIllegalBlockSizeException);
    }
    catch (NoSuchPaddingException localNoSuchPaddingException)
    {
      throw new an.a(localNoSuchPaddingException);
    }
    catch (BadPaddingException localBadPaddingException)
    {
      throw new an.a(localBadPaddingException);
    }
    catch (InvalidAlgorithmParameterException localInvalidAlgorithmParameterException)
    {
      throw new an.a(localInvalidAlgorithmParameterException);
    }
  }
}
