...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator
{
  ...
  private void startAnimation()
  {
    ...
    for (int k = 0; ; k++)
    {
      if (k >= j)
      {
        this.mAnimatorMap.put(localValueAnimator, new ViewPropertyAnimatorPreHC.PropertyBundle(i, localArrayList));
      ...
      i |= ((ViewPropertyAnimatorPreHC.NameValuesHolder)localArrayList.get(k)).mNameConstant;
    }
  }
