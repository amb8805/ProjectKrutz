  ...
  implements PageIndicator
{
  ...
  private final View.OnClickListener mTabClickListener = new el7rTabPageIndicator.1(this);
  private final LinearLayout mTabLayout;
  private el7rTabPageIndicator.OnTabReselectedListener mTabReselectedListener;
  private Runnable mTabSelector;
  private ViewPager mViewPager;

  public el7rTabPageIndicator(Context paramContext)
  {
    this(paramContext, null);
  }

  public el7rTabPageIndicator(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    el7rTabPageIndicator.TabView localTabView = new el7rTabPageIndicator.TabView(this, getContext());
    el7rTabPageIndicator.TabView.access$0(localTabView, paramInt);
    ...
    localTabView.setTextSize(13.0F);
    localTabView.setTypeface(Typeface.createFromAsset(this.context.getAssets(), "fonts/roboto/roboto_l.ttf"));
    localTabView.setTextSize(15.0F);
  ...
  private void animateToTab(int paramInt)
  {
    ...
    this.mTabSelector = new el7rTabPageIndicator.2(this, localView);
  ...
  public void setOnTabReselectedListener(el7rTabPageIndicator.OnTabReselectedListener paramOnTabReselectedListener)
  {
...
/* Location:
 * Qualified Name:     codeadore.textgram.custom_widgets.el7rTabPageIndicator
