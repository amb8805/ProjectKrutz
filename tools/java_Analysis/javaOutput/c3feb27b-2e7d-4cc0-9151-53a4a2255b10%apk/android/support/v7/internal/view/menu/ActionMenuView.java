  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    while (i13 < i12)
    {
      ...
      else
      {
        ...
        ActionMenuView.LayoutParams localLayoutParams5 = (ActionMenuView.LayoutParams)localView4.getLayoutParams();
    ...
    int i22;
    int i23;
    label445: ActionMenuView.LayoutParams localLayoutParams4;
    if ((i11 != 0) && (i10 == 2))
    {
      i14 = 1;
      i15 = 0;
      ...
      if (i23 >= i12)
        break label542;
      localLayoutParams4 = (ActionMenuView.LayoutParams)getChildAt(i23).getLayoutParams();
    ...
    if (i22 > i6)
    {
      ...
      if (i16 == 0)
      {
        if (((1L & l1) != 0L) && (!((ActionMenuView.LayoutParams)getChildAt(0).getLayoutParams()).preventEdgeOffset))
          f -= 0.5F;
        if (((l1 & 1 << i12 - 1) != 0L) && (!((ActionMenuView.LayoutParams)getChildAt(i12 - 1).getLayoutParams()).preventEdgeOffset))
          f -= 0.5F;
      }
      if (f <= 0.0F)
        break label884;
    ...
    while (true)
    {
      ...
      if (i25 < i12)
      {
        ...
        ActionMenuView.LayoutParams localLayoutParams3 = (ActionMenuView.LayoutParams)localView3.getLayoutParams();
        if ((l2 & 1 << i25) == 0L)
  ...
  protected boolean hasSupportDividerBeforeChildAt(int paramInt)
  {
    ...
    if ((paramInt > 0) && ((localView2 instanceof ActionMenuView.ActionMenuChildView)))
      bool1 |= ((ActionMenuView.ActionMenuChildView)localView2).needsDividerBefore();
    return bool1;
  }
