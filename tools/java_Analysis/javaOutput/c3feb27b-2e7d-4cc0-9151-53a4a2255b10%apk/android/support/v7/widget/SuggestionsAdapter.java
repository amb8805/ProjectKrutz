  ...
  implements View.OnClickListener
{
  ...
  private Drawable getDrawable(Uri paramUri)
  {
    ...
    //   26: areturn
    //   27: astore 12
    //   29: new 272	java/io/FileNotFoundException
    //   32: dup
    //   33: new 208	java/lang/StringBuilder
    //   36: dup
    //   37: invokespecial 209	java/lang/StringBuilder:<init>	()V
    //   40: ldc_w 293
    //   43: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   46: aload_1
    //   47: invokevirtual 296	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   50: invokevirtual 224	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   53: invokespecial 299	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
    //   56: athrow
    //   57: astore_2
    //   58: ldc 16
    //   60: new 208	java/lang/StringBuilder
    //   63: dup
    //   64: invokespecial 209	java/lang/StringBuilder:<init>	()V
    //   67: ldc_w 301
    //   70: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   73: aload_1
    //   74: invokevirtual 296	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   77: ldc_w 303
    //   80: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   83: aload_2
    //   84: invokevirtual 306	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    ...
    //   93: invokestatic 193	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   96: pop
    //   97: aconst_null
    //   98: areturn
    //   99: aload_0
    //   100: getfield 91	android/support/v7/widget/SuggestionsAdapter:mProviderContext	Landroid/content/Context;
    //   103: invokevirtual 310	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   106: aload_1
    //   107: invokevirtual 316	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   110: astore 5
    //   112: aload 5
    //   114: ifnonnull +31 -> 145
    //   117: new 272	java/io/FileNotFoundException
    //   120: dup
    //   121: new 208	java/lang/StringBuilder
    //   124: dup
    //   125: invokespecial 209	java/lang/StringBuilder:<init>	()V
    //   128: ldc_w 318
    //   131: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   134: aload_1
    //   135: invokevirtual 296	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   138: invokevirtual 224	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   141: invokespecial 299	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
    //   144: athrow
    //   145: aload 5
    //   147: aconst_null
    //   148: invokestatic 322	android/graphics/drawable/Drawable:createFromStream	(Ljava/io/InputStream;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    //   151: astore 9
    //   153: aload 5
    //   155: invokevirtual 327	java/io/InputStream:close	()V
    //   158: aload 9
    //   160: areturn
    //   161: astore 10
    //   163: ldc 16
    ...
    //   172: ldc_w 329
    //   175: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   178: aload_1
    //   179: invokevirtual 296	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   182: invokevirtual 224	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   185: aload 10
    //   187: invokestatic 333	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   190: pop
    //   191: aload 9
    //   193: areturn
    //   194: astore 6
    ...
    //   204: astore 7
    //   206: ldc 16
    //   208: new 208	java/lang/StringBuilder
    //   211: dup
    //   212: invokespecial 209	java/lang/StringBuilder:<init>	()V
    //   215: ldc_w 329
    //   218: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   221: aload_1
    //   222: invokevirtual 296	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   225: invokevirtual 224	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   228: aload 7
    //   230: invokestatic 333	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   233: pop
    //   234: goto -33 -> 201
    //
    // Exception table:
    //   from	to	target	type
    //   17	24	27	android/content/res/Resources$NotFoundException
    //   0	12	57	java/io/FileNotFoundException
    //   17	24	57	java/io/FileNotFoundException
    //   29	57	57	java/io/FileNotFoundException
    //   99	112	57	java/io/FileNotFoundException
    //   117	145	57	java/io/FileNotFoundException
    //   153	158	57	java/io/FileNotFoundException
    //   163	191	57	java/io/FileNotFoundException
    //   196	201	57	java/io/FileNotFoundException
    //   201	204	57	java/io/FileNotFoundException
    //   206	234	57	java/io/FileNotFoundException
    ...
    throws FileNotFoundException
  {
    ...
    label286: return localResources.getDrawable(j);
  }
