...
public class ViewPager extends ViewGroup
{
  ...
  private void calculatePageOffsets(ViewPager.ItemInfo paramItemInfo1, int paramInt, ViewPager.ItemInfo paramItemInfo2)
  {
    ...
    else
    {
      for (int i9 = i5 + 1; ; i9++)
      {
        if ((i9 > paramItemInfo1.position) || (i8 >= this.mItems.size()))
          break label371;
        ViewPager.ItemInfo localItemInfo4 = (ViewPager.ItemInfo)this.mItems.get(i8);
        while (true)
          if ((i9 > localItemInfo4.position) && (i8 < -1 + this.mItems.size()))
          {
            i8++;
            localItemInfo4 = (ViewPager.ItemInfo)this.mItems.get(i8);
            continue;
            f1 = 0.0F;
            break;
          }
    ...
    if (i5 > paramItemInfo1.position)
    {
      ...
      {
        for (ViewPager.ItemInfo localItemInfo3 = (ViewPager.ItemInfo)this.mItems.get(i6); (i7 < localItemInfo3.position) && (i6 > 0); localItemInfo3 = (ViewPager.ItemInfo)this.mItems.get(i6))
          i6--;
  ...
  void dataSetChanged()
  {
    ...
    int m;
    int n;
    label55: ViewPager.ItemInfo localItemInfo;
    int i3;
    ...
    if (j != 0)
    {
      ...
      {
        ViewPager.LayoutParams localLayoutParams = (ViewPager.LayoutParams)getChildAt(i2).getLayoutParams();
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.mPageMargin > 0) && (this.mMarginDrawable != null) && (this.mItems.size() > 0) && (this.mAdapter != null))
    {
      ...
      i1 = ((ViewPager.ItemInfo)this.mItems.get(m - 1)).position;
    }
    for (int i2 = n; ; i2++)
    {
      float f4;
      if (i2 < i1)
      {
        while ((i2 > localItemInfo.position) && (k < m))
        {
          ...
          k++;
          localItemInfo = (ViewPager.ItemInfo)localArrayList.get(k);
        }
  ...
  void populate(int paramInt)
  {
    int i = 2;
    int j = this.mCurItem;
    ViewPager.ItemInfo localItemInfo1 = null;
    if (j != paramInt)
    {
    ...
    while (true)
    {
      ...
      if (getWindowToken() != null)
      {
        ...
        if (i2 < i3)
        {
          ViewPager.ItemInfo localItemInfo8 = (ViewPager.ItemInfo)this.mItems.get(i2);
        ...
        float f1;
        int i9;
        ViewPager.ItemInfo localItemInfo5;
        label382: int i10;
        float f2;
        label396: int i11;
        float f3;
        int i12;
        ViewPager.ItemInfo localItemInfo6;
        label479: float f4;
        label487: int i14;
        ...
        if (localObject1 != null)
        {
          ...
          if (i9 >= 0)
          {
            localItemInfo5 = (ViewPager.ItemInfo)this.mItems.get(i9);
            i10 = getClientWidth();
            if (i10 > 0)
              break label684;
            f2 = 0.0F;
            ...
            if (f3 < 2.0F)
            {
              ...
              if (i12 >= i13)
                break label911;
              localItemInfo6 = (ViewPager.ItemInfo)this.mItems.get(i12);
              if (i10 > 0)
                break label917;
              f4 = 0.0F;
              i14 = 1 + this.mCurItem;
            ...
            calculatePageOffsets((ViewPager.ItemInfo)localObject1, i2, localItemInfo1);
          }
        }
        else
        {
        ...
        label1030: label1163: for (Object localObject2 = ((ViewPager.ItemInfo)localObject1).object; ; localObject2 = null)
        {
          ...
          for (int i6 = 0; i6 < i5; i6++)
          {
            ...
            {
              ViewPager.ItemInfo localItemInfo4 = infoForChild(localView3);
          ...
          localItemInfo5 = null;
          break label382;
          label684: f2 = 2.0F - ((ViewPager.ItemInfo)localObject1).widthFactor + getPaddingLeft() / i10;
          break label396;
          ...
          label792: for (localItemInfo5 = (ViewPager.ItemInfo)this.mItems.get(i9); ; localItemInfo5 = null)
          {
            i11--;
            break;
          }
          label798: if (localItemInfo5 != null)
          {
            ...
            if (i11 == i21)
            {
              ...
              i9--;
              if (i9 >= 0);
              for (localItemInfo5 = (ViewPager.ItemInfo)this.mItems.get(i9); ; localItemInfo5 = null)
                break;
            }
          }
          int i20 = i9 + 1;
          ...
          for (localItemInfo6 = (ViewPager.ItemInfo)this.mItems.get(i12); ; localItemInfo6 = null)
          {
            i14++;
            break;
          }
          ...
          ViewPager.ItemInfo localItemInfo7 = addNewItem(i14, i12);
          i12++;
        ...
        if (hasFocus())
        {
          View localView1 = findFocus();
          if (localView1 != null);
          for (ViewPager.ItemInfo localItemInfo2 = infoForAnyChild(localView1); ; localItemInfo2 = null)
          {
            ...
            for (int i7 = 0; ; i7++)
            {
              ...
              ViewPager.ItemInfo localItemInfo3 = infoForChild(localView2);
  ...
  {
    // Byte code:
    //   0: getstatic 867	android/os/Build$VERSION:SDK_INT	I
    //   3: bipush 7
    //   5: if_icmplt +66 -> 71
    //   8: aload_0
    //   9: getfield 1219	android/support/v4/view/ViewPager:mSetChildrenDrawingOrderEnabled	Ljava/lang/reflect/Method;
    //   12: ifnonnull +30 -> 42
    //   15: iconst_1
    //   16: anewarray 639	java/lang/Class
    //   19: astore 9
    //   21: aload 9
    //   23: iconst_0
    //   24: getstatic 1225	java/lang/Boolean:TYPE	Ljava/lang/Class;
    //   27: aastore
    //   28: aload_0
    //   29: ldc 4
    //   31: ldc_w 1227
    //   34: aload 9
    //   36: invokevirtual 1231	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   39: putfield 1219	android/support/v4/view/ViewPager:mSetChildrenDrawingOrderEnabled	Ljava/lang/reflect/Method;
    //   42: aload_0
    //   43: getfield 1219	android/support/v4/view/ViewPager:mSetChildrenDrawingOrderEnabled	Ljava/lang/reflect/Method;
    //   46: astore 4
    //   48: iconst_1
    //   49: anewarray 633	java/lang/Object
    //   52: astore 5
    //   54: aload 5
    //   56: iconst_0
    //   57: iload_1
    //   58: invokestatic 1235	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   61: aastore
    //   62: aload 4
    //   64: aload_0
    //   65: aload 5
    //   67: invokevirtual 1241	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   70: pop
    //   71: return
    //   72: astore 7
    //   74: ldc 37
    //   76: ldc_w 1243
    //   79: aload 7
    //   81: invokestatic 1246	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   84: pop
    //   85: goto -43 -> 42
    //   88: astore_2
    //   89: ldc 37
    //   91: ldc_w 1248
    //   94: aload_2
    //   95: invokestatic 1246	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   98: pop
    //   99: return
    //
    // Exception table:
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      if ((paramInt1 <= i + this.mCurItem) && (paramInt1 >= this.mCurItem - i))
        break;
      for (int j = 0; j < this.mItems.size(); j++)
        ((ViewPager.ItemInfo)this.mItems.get(j)).scrolling = bool;
