  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private FragmentTransaction doTabChanged(String paramString, FragmentTransaction paramFragmentTransaction)
  {
    ...
    if (this.mLastTab != localObject)
    {
      ...
      if (localObject != null)
      {
        if (FragmentTabHost.TabInfo.access$100(localObject) != null)
          break label190;
        FragmentTabHost.TabInfo.access$102(localObject, Fragment.instantiate(this.mContext, FragmentTabHost.TabInfo.access$300(localObject).getName(), FragmentTabHost.TabInfo.access$400(localObject)));
        paramFragmentTransaction.add(this.mContainerId, FragmentTabHost.TabInfo.access$100(localObject), FragmentTabHost.TabInfo.access$200(localObject));
      }
    }
    while (true)
    {
      ...
      label190: paramFragmentTransaction.attach(FragmentTabHost.TabInfo.access$100(localObject));
    }
  }
