...
public final class c extends m
  implements AbsListView.OnScrollListener, a<NewRelease>, g, ab, bz
{
  private View Y;
  private View Z;
  ...
  private h ah;
  private com.spotify.mobile.android.spotlets.browse.datasource.a.c ai;
  ...
  public final void a(Bundle paramBundle)
  {
    ...
    this.ah = new h(i(), "spotify:app:browse:new_releases");
    this.ah.b(paramBundle);
    this.ah.a();
    this.ae = dv.a(i(), ViewUri.l);
    this.i = new com.spotify.mobile.android.spotlets.browse.a.c(i().getResources().getInteger(2131558407), this.ac);
    this.ai = new com.spotify.mobile.android.spotlets.browse.datasource.a.c(this, g().getString("country"));
  }
  ...
  public final void a(View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ArrayList localArrayList = paramBundle.getParcelableArrayList("new_releases");
      a(localArrayList, null, localArrayList.size(), false, RequestType.e);
  ...
  public final void a(List<NewRelease> paramList, Map<String, ? extends Object> paramMap, int paramInt, boolean paramBoolean, RequestType paramRequestType)
  {
    this.af = false;
    if (!n_());
    do
  ...
  public final void d(Bundle paramBundle)
  {
    ...
    paramBundle.putParcelableArrayList("new_releases", localArrayList);
...
/* Location:
 * Qualified Name:     com.spotify.mobile.android.spotlets.browse.c
