...
public final class ah
{
  public static int a(Parcel paramParcel)
  {
    ...
    if ((0xFFFF & i) != 20293)
      throw new ah.a("Expected object header. Got 0x" + Integer.toHexString(i), paramParcel);
    int m = k + j;
    if ((m < k) || (m > paramParcel.dataSize()))
      throw new ah.a("Size read is invalid start=" + k + " end=" + m, paramParcel);
    return m;
  }
  ...
  private static void a(Parcel paramParcel, int paramInt1, int paramInt2)
  {
    ...
    if (i != paramInt2)
      throw new ah.a("Expected size " + paramInt2 + " got " + i + " (0x" + Integer.toHexString(i) + ")", paramParcel);
  }
