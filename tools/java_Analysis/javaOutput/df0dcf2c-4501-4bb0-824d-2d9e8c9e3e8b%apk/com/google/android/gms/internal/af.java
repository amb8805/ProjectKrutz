...
public final class af extends Button
{
  ...
  public final void a(Resources paramResources, int paramInt1, int paramInt2)
  {
    ...
    {
      bool2 = bool1;
      label16: f.a(bool2, "Unknown button size " + paramInt1);
      if ((paramInt2 < 0) || (paramInt2 >= 2))
        break label174;
    }
    while (true)
    {
      f.a(bool1, "Unknown color scheme " + paramInt2);
    ...
    default:
      throw new IllegalStateException("Unknown button size: " + paramInt1);
    case 0:
      setText(paramResources.getString(d.b));
      return;
    case 1:
      setText(paramResources.getString(d.c));
      return;
    case 2:
    }
    setText(null);
