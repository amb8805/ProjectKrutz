...
public final class UTF8StreamJsonParser extends ParserBase
{
  ...
  private void _skipCComment()
  {
    ...
    label213: _reportInvalidEOF(" in a comment");
  }
  ...
  protected final String _getText2(JsonToken paramJsonToken)
  {
    if (paramJsonToken == null)
      return null;
    switch (UTF8StreamJsonParser.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[paramJsonToken.ordinal()])
    {
    default:
  ...
  public final char[] getTextCharacters()
  {
    ...
    {
      switch (UTF8StreamJsonParser.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()])
      {
      default:
