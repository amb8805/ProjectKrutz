...
public final class ReaderBasedJsonParser extends ParserBase
{
        ...
        while (true)
        {
          ...
          if ((i7 == 101) || (i7 == 69))
          {
            ...
            if (this._inputPtr < this._inputEnd)
            {
              ...
              break;
              label615: char[] arrayOfChar11 = this._inputBuffer;
          ...
          label789: label804: label811: label843: for (int i30 = 0; ; i30 = i25)
          {
            i25 = i30 + 1;
            ...
            break label374;
            label740: i14 = getNextChar("expected a digit for number exponent");
            arrayOfChar5 = arrayOfChar4;
            i15 = 0;
            break label466;
            label759: char[] arrayOfChar6 = this._inputBuffer;
  ...
  protected final String _getText2(JsonToken paramJsonToken)
  {
    if (paramJsonToken == null)
      return null;
    switch (ReaderBasedJsonParser.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[paramJsonToken.ordinal()])
    {
    default:
  ...
  public final char[] getTextCharacters()
  {
    ...
    {
      switch (ReaderBasedJsonParser.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()])
      {
      default:
  ...
  public final JsonToken nextToken()
  {
    ...
    if (i == 93)
    {
      if (!this._parsingContext.inArray())
        _reportMismatchedEndMarker(i, (char)'}');
