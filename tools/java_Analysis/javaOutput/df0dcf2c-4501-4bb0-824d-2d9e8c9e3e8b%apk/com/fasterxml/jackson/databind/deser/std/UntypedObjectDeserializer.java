...
public class UntypedObjectDeserializer extends StdDeserializer<Object>
{
  ...
  {
    switch (UntypedObjectDeserializer.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[paramJsonParser.getCurrentToken().ordinal()])
    {
    case 2:
    case 4:
    default:
  ...
  public Object deserializeWithType(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext, TypeDeserializer paramTypeDeserializer)
  {
    ...
    switch (UntypedObjectDeserializer.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[localJsonToken.ordinal()])
    {
    case 2:
    case 4:
    default:
