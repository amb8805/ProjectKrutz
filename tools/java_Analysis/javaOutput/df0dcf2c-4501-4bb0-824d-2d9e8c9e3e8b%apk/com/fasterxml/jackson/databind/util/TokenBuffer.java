...
public class TokenBuffer extends JsonGenerator
{
  ...
  {
    switch (TokenBuffer.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[paramJsonParser.getCurrentToken().ordinal()])
    {
    default:
    ...
    case 6:
      ...
      return;
    case 7:
      switch (TokenBuffer.1.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[paramJsonParser.getNumberType().ordinal()])
      {
      default:
  ...
  public void copyCurrentStructure(JsonParser paramJsonParser)
  {
    ...
    switch (TokenBuffer.1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[localJsonToken.ordinal()])
    {
    case 2:
    default:
