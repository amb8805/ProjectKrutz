    ...
    while ((this._modifiers != null) && (!((JavaType)localObject).isContainerType()))
    {
      ...
      while (true)
        if (j < i)
        {
          ...
          StringBuilder localStringBuilder = new StringBuilder("Unrecognized Type: ");
          if (paramType == null);
  ...
  protected final JavaType _fromClass(Class<?> paramClass, TypeBindings paramTypeBindings)
  {
    ...
    while (true)
    {
      ...
      synchronized (this._typeCache)
      {
        ...
        {
          localObject3 = ArrayType.construct(_constructType(paramClass.getComponentType(), null), null, null);
          synchronized (this._typeCache)
          {
