    ...
    while (true)
    {
      ...
      synchronized (a)
      {
        ...
        if (n > 60)
        {
          ...
          i7 = i5;
          arrayOfChar[0] = k;
          int i8 = a(arrayOfChar, i2, (char)'d', 1, false);
          if (i8 != i)
          {
            int i9 = i;
            int i11 = a(arrayOfChar, i4, (char)'h', i8, i9);
            if (i11 == i)
              continue;
            int i12 = i;
            int i14 = a(arrayOfChar, i7, (char)'m', i11, i12);
            if (i14 == i)
              continue;
            int i15 = a(arrayOfChar, m, (char)'m', a(arrayOfChar, i6, (char)'s', i14, i), true);
            arrayOfChar[i15] = 's';
            j = i15 + 1;
            continue;
            paramLong = -paramLong;
