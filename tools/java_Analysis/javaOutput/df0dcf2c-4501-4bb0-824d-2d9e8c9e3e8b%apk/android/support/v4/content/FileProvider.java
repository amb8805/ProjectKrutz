...
public class FileProvider extends ContentProvider
{
  ...
  private static d a(Context paramContext, String paramString)
  {
    Object localObject2;
    synchronized (c)
    {
      localObject2 = (d)c.get(paramString);
          ...
          while (true)
          {
            ...
            if (i == 2)
            {
              ...
              if (localObject3 != null)
                ((e)localObject2).a(str2, (File)localObject3);
            }
          }
        }
    ...
    while (true)
    {
      ...
      else if ("external-path".equals(str1))
      {
        ...
        continue;
        label297: c.put(paramString, localObject2);
        return localObject2;
      }
      else
      {
