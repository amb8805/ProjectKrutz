  ...
  implements ac, p
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (i3 < j)
    {
      ...
      {
        int i24 = localView3.getMeasuredWidth();
        if (a(i3))
          i24 += m;
        int i25 = localView3.getMeasuredHeight();
        int i26 = getWidth() - getPaddingRight() - localLayoutParams2.rightMargin;
        int i27 = i26 - i24;
        int i28 = k - i25 / 2;
        localView3.layout(i27, i28, i26, i25 + i28);
        i20 = i1 - i24;
        i19 = 1;
        i21 = n;
      }
    ...
    while (true)
    {
      ...
      i2 = i19;
      break label64;
      int i22 = i1 - (localView3.getMeasuredWidth() + localLayoutParams2.leftMargin + localLayoutParams2.rightMargin);
      a(i3);
      i21 = n + 1;
      int i23 = i2;
      i20 = i22;
      ...
      int i8;
      int i9;
      label386: ActionMenuView.LayoutParams localLayoutParams1;
      int i11;
      int i12;
      if (i2 != 0)
      {
      ...
      label513: label519: for (int i10 = i11 + (i7 + (i12 + localLayoutParams1.rightMargin)); ; i10 = i8)
      {
        i9++;
        i8 = i10;
        break label386;
