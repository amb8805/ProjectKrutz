...
final class j extends BaseAdapter
{
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 1:
      ...
      {
        paramView = LayoutInflater.from(this.a.getContext()).inflate(h.i, paramViewGroup, false);
        paramView.setId(1);
        ((TextView)paramView.findViewById(f.E)).setText(this.a.getContext().getString(i.c));
      }
    case 0:
    }
    do
    {
      return paramView;
      if ((paramView == null) || (paramView.getId() != f.q))
        paramView = LayoutInflater.from(this.a.getContext()).inflate(h.i, paramViewGroup, false);
      PackageManager localPackageManager = this.a.getContext().getPackageManager();
      ImageView localImageView = (ImageView)paramView.findViewById(f.o);
      ResolveInfo localResolveInfo = (ResolveInfo)getItem(paramInt);
      localImageView.setImageDrawable(localResolveInfo.loadIcon(localPackageManager));
      ((TextView)paramView.findViewById(f.E)).setText(localResolveInfo.loadLabel(localPackageManager));
    }
