...
public class test3 {
	...
	/*
Test adding intents/permissions to the system
		...
		// Check to see if the intent exists in the intent table, if not then add it
			...
			// Next insert the information into the apk tools table
		     ...
		     if(rs.getInt("countrowID") < 1){
		    	 ...
		    	 stmt = c.createStatement();
			     String sql = "INSERT INTO ToolResults (apkID) VALUES ("+RowID+" );"; 
			     stmt.executeUpdate(sql);  
			     c.commit();
		     }
		     stmt.close();
		    ...
		    // String sql = "INSERT INTO ToolResults (apkID, apkParser_versionCode, apkParser_VersionName, 
		     ...
		     String sql = "Update toolResults set apkParser_versionCode='"+versionCode+"', apkParser_VersionName='"+versionName+"', apkParser_minsdk='"+minsdk+"' where rowID=" + RowID;
		    // System.out.println(sql);
